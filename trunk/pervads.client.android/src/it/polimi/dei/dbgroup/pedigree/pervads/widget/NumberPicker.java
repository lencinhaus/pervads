...
package it.polimi.dei.dbgroup.pedigree.pervads.widget;
...
public class NumberPicker extends LinearLayout implements OnClickListener,
	...
	private static final LayoutInflater.Factory CUSTOM_FACTORY = new LayoutInflater.Factory() {

		@Override
		public View onCreateView(String name, Context context,
				AttributeSet attrs) {
			if (NumberPickerButton.class.getName().equals(name)) {
				NumberPickerButton npb = new NumberPickerButton(context, attrs);
				return npb;
			}
	...
	public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
		...
		LayoutInflater inflater = ((LayoutInflater) context
				...
				.cloneInContext(this.getContext());
		inflater.setFactory(CUSTOM_FACTORY);
