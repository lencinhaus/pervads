...
public class AssignmentAdapter extends BaseAdapter {
	...
	private List<LightweightAssignment> assignments;
	...
	public AssignmentAdapter(Context context, List<LightweightAssignment> assignments) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		LightweightAssignment assignment = assignments.get(position);
		if (convertView == null) {
